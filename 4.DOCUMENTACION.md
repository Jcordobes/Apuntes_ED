...
### comandos
    ...
    - __git merge rama2 ->__ Fusiona la rama actual con una otra, como podría ser una rama master, las ramas se siguen          manteniendo pero apertenecen a otra rama, es decir, a nuestra rama master. 
